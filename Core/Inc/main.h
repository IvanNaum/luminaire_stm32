...
#define SEG_G_Pin LL_GPIO_PIN_1
#define SEG_G_GPIO_Port GPIOA
#define SEG_F_Pin LL_GPIO_PIN_2
#define SEG_F_GPIO_Port GPIOA
#define SEG_E_Pin LL_GPIO_PIN_3
#define SEG_E_GPIO_Port GPIOA
#define SEG_D_Pin LL_GPIO_PIN_4
#define SEG_D_GPIO_Port GPIOA
#define SEG_C_Pin LL_GPIO_PIN_5
